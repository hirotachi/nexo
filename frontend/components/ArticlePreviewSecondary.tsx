...
import styles from "@modules/ArticlePreviewSecondary.module.scss";
import clsx from "clsx";
import Link from "next/link";

export const articlePreviewSecondary: TArticlePreview = {
...
const ArticlePreviewSecondary = (props: ArticlePreviewProps) => {
...
export default ArticlePreviewSecondary;
